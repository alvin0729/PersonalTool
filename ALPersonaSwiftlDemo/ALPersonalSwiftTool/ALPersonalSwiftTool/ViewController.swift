...
//  ALPersonalSwiftTool
//
//  Created by Alvin on 2017/11/25.
...
extension ViewController{
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let controllerVCStr : String = sections[indexPath.section].items[indexPath.row].detail
        if controllerVCStr == "JobSummaryController" {
            self.navigationController?.pushViewController(JobSummaryController(), animated: true)
        }
    }
