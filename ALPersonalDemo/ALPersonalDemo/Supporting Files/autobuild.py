...
#./autobuild.py -w zhiyin.xcworkspace -s zhiyin -o ~/Desktop/zhiyin.ipa
#./autobuild.py -p zhiyin.xcodeproj -t zhiyin -o ~/Desktop/zhiyin.ipa
#python autobuild.py -p zhiyin.xcodeproj -t zhiyin -o ~/Desktop/zhiyin.ipa
