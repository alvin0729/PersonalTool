...
@property (nonatomic, strong) NSMutableArray *trackingViewsArray;
...
- (void)commonInit {
    ...
    self.trackingViewsArray = [NSMutableArray array];
...
- (void)addTrackingViewWithRect:(CGRect)rect index:(NSInteger)index {
    
//    if (self.scrollView.subviews.count < self.sectionTitles.count) {
//        
...
//        view.trackingId = [NSString stringWithFormat:@"%@&HMSegmentedControl&index=%zd",vcName,index];
//        [self.scrollView addSubview:view];
//        [self.trackingViewsArray addObject:view];
//    }
}
...
//            [self addTrackingViewWithRect:rect index:idx];
            // Vertical Divider
