...
- (void)_setupSubViews
{
    ...
    divider.backgroundColor = [UIColor cyanColor];
...
- (void)layoutSubviews
{
    ...
    // 布局子控件
    self.divider.frame = CGRectMake(0, self.viewHeight-MHGlobalBottomLineHeight, self.viewHeight, MHGlobalBottomLineHeight);
