...
{
    // 设置颜色
    self.backgroundColor = MHcolorWithHexString(@"#EEEEEE");
    self.contentView.backgroundColor = MHcolorWithHexString(@"#EEEEEE");
}
...
- (void)setFrame:(CGRect)frame
{
    ...
    frame.size.width = kALScreenWidth - frame.origin.x - MHTopicHorizontalSpace;
