...
- (void)viewDidLoad {
    ...
    self.tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 64, kALScreenWidth, kALScreenHeight - 64) style:UITableViewStylePlain];
    ...
    dataSource = @[@"1.监听",
                 @"ALToastTableViewController+提示加载",@"ALReactiveCocoaDemoVC+RAC",@"ALDemo1ViewController+暂时显示"];
}
